...
public:
  ...
  virtual void ToggleThirdPerson(){}
	...
	virtual bool ForceBleed() {return false;}

	virtual void SetProgress(int p1, int p2) {m_progress1=p1; m_progress2=p2;}
	virtual void GetProgress(int &p1, int &p2) {p1=m_progress1; p2=m_progress2;}
...
public:
	...
	void	SetDropWeaponTimer( CWeapon*pWeapon2Drop, float delay );
	void	ForceAutoDrop();

...
public:
  ...
  virtual void SetDestination(const Vec3& pos){ m_destination = pos; }
	...
	virtual bool		IsTrainMounted() {return m_properties.trainmounted;};
	virtual Vec3		GetTrainMountedDir() {return m_stats.mount_dir;};
...
//	void		ActivateLamLight(bool activate, bool aiRequest = true);
  ...
  virtual bool ApplyActorRecoil() const { return true; }
	...
	virtual void SetAutoPicked(bool set){m_bAutoPicked=set;}
	bool GetAutoPicked() const {return m_bAutoPicked;}

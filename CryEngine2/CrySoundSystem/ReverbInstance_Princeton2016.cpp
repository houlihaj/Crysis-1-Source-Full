...
void CReverbInstance_Princeton2016::FmodErrorOutput(const char * sDescription, IMiniLog::ELogType LogType)
{
	switch(LogType) 
	{
...
bool CReverbInstance_Princeton2016::Activate()
{
	...
	if (m_pCSEX && !m_DSPReverb)
	{
		...
		{
			FmodErrorOutput("load /Libs/ReverbPlugins/VST_Princeton2016.dll reverb failed! ", IMiniLog::eError);
			return false;
		}

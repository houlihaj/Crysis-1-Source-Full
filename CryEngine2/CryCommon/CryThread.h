...
// Typedefs.
//////////////////////////////////////////////////////////////////////////
typedef CryLock<CRYLOCK_RECURSIVE>   CryCriticalSection;
typedef CryLock<CRYLOCK_FAST>        CryCriticalSectionNonRecursive;
...
#define AUTO_LOCK_T(Type, lock)		CryAutoLock<Type> __AutoLock(lock)

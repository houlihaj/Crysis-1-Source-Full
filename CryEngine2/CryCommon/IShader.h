...
struct SRenderObjData
{
  struct IRenderMesh *				m_pLMTCBufferO;
	struct IRenderMesh *				m_pScatterBuffer;
...
struct STexState
{
  ...
  _inline friend bool operator == (const STexState &m1, const STexState &m2)
  {
    if (*(uint *)&m1.m_nMinFilter == *(uint *)&m2.m_nMinFilter &&
        ...
        *(ushort *)&m1.m_bComparison == *(ushort *)&m2.m_bComparison)
      return true;
    return false;
  }
  void Release()
...
#define EF2_SUBSURFSCATTER 0x80000
...
#define EF2_BLENDSUBSURFSCATTER 0x8000000

#define GENFLAGS_FORCE_VERTEX_SCATTER 0x40000000

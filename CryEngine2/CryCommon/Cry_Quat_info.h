...
STRUCT_INFO_T_BEGIN(QuatD_tpl, typename, F)
STRUCT_VAR_INFO(nq, TYPE_INFO(Quat_tpl<F>))
STRUCT_VAR_INFO(dq, TYPE_INFO(Quat_tpl<F>))
STRUCT_INFO_T_END(QuatD_tpl, typename, F)

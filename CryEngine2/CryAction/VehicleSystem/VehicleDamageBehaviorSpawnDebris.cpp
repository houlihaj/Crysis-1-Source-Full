...
//------------------------------------------------------------------------
bool CVehicleDamageBehaviorSpawnDebris::Init(IVehicle* pVehicle, const SmartScriptTable &table)
{
	m_pVehicle = pVehicle;
...
{
	if (IParticleEffect *pEffect = gEnv->p3DEngine->FindParticleEffect(effectName, "VehicleDamageBehaviorEffect"))
	{

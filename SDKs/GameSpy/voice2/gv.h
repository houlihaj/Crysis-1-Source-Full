...
/////////
#if defined(_PSP)
	#define GV_SAMPLES_PER_SECOND        11025
#else
	#define GV_SAMPLES_PER_SECOND         8000
#endif
#define GV_BYTES_PER_SAMPLE          (sizeof(GVSample) / sizeof(GVByte))
#define GV_BITS_PER_SAMPLE           (GV_BYTES_PER_SAMPLE * 8)
#define GV_BYTES_PER_SECOND          (GV_SAMPLES_PER_SECOND * GV_BYTES_PER_SAMPLE)

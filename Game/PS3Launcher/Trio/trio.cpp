...
/*
 * 2006-03-23 saschad@crytek.de:
 * - Stripped down to the bare minimum for sprintf/cprintf/sscanf/dscanf.
 * - Converted to C++.
 * - Fixed broken sscanf conversion for float arguments.
 */
...
static TRIO_CONST char rcsid3[] = "@(#)$Id: trio.c,v 1.75 2003/03/01 15:34:01 breese Exp $";
 ...
 */
TRIO_PUBLIC int
STD_PREFIX trio_sscanf
TRIO_VARGS3((buffer, format, va_alist),
	    TRIO_CONST char *RESTRICT buffer,
	    TRIO_CONST char *RESTRICT format,
	    TRIO_VA_DECL)
{
  int status;
  va_list args;

...
PLUGIN_API IPlugin * CreatePluginInstance(PLUGIN_INIT_PARAM * pInitParam)
{
	...
	pInitParam->pIEditorInterface->GetClassFactory()->RegisterClass(new CAlienBrainSourceControl);
	g_pSystem->GetILog()->Log("Alienbrain plugin: CreatePluginInstance");
	return new CAlienBrainPlugin;
}

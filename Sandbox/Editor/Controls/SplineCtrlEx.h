...
// Spline control.
//////////////////////////////////////////////////////////////////////////
class CSplineCtrlEx : public CWnd, public IKeyTimeSet
{
...
public:
	...
	float SnapTimeToGridVertical(float time) {return int((time * m_fGridTimeScale) + 0.5f) * (1.0f / m_fGridTimeScale);}
...
protected:
	...
	void DrawKeys(CDC* pDC, SSplineInfo& splineInfo, float startTime, float endTime);
	...
	void ClearSelection();
	void SelectKey(ISplineInterpolator* pSpline, int nKey, int nDimension,bool bSelect);
	bool IsKeySelected(ISplineInterpolator* pSpline, int nKey, int nDimension);
	int GetNumSelected();

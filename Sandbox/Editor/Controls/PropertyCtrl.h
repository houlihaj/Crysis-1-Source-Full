...
public:
	...
	virtual void Create( DWORD dwStyle,const CRect &rc,CWnd *pParent=NULL,UINT nID=0, bool bAcceptRestriction=false );
...
protected:
	...
	static std::set<CString> m_expandHistory;

	bool m_bIsCanExtended;

	bool m_bAcceptRestriction;

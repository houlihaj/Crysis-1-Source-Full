...
protected:
  ...
  CVehicleHelper* CreateHelperObject(const Vec3& pos, const Vec3& dir, const CString& name, bool unique, bool select, bool editLabel, CVehiclePart* pParent = 0, IVariable* pHelperVar = 0 );
  ...
  CSplitterWndEx m_vSplitter;
  CSplitterWndEx m_hSplitter;

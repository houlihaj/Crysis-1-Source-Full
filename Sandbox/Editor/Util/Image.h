...
public:
	...
	void SetSubImage( int x1,int y1,const TImage<T> &subImage, float heightOffset=0.0f )
	{
	...
	void SetFormatDescription( const CString &str ) { m_formatDescription = str; };
	const CString& GetFormatDescription() const { return m_formatDescription; };

...
void CDisplaySettings::SetRenderFlags( int flags )
{
	...
	SetCVar( "e_detail_materials",m_renderFlags&RENDER_FLAG_DETAILTEX );
	...
	SetCVar( "e_proc_vegetation",m_renderFlags&RENDER_FLAG_DETAILOBJ );
	...
	//SetCVar( "e_imposters",m_renderFlags&RENDER_FLAG_IMPOSTERS );

...
public:
	...
	CVariable<bool> SourceControlOn;
	CVariable<CString> SourceControlPluginName;
...
public:
	virtual const char* GetCategory() { return "General Settings"; }
	virtual const char* GetTitle() { return "Source Control"; }
	...
	CPreferencesPage_SSafe()
	{
		...
		AddVariable( tableSSafe,"Source Control Settings" );
		AddVariable( tableSSafe,SourceControlOn,"Enabled" );
	...
	void UpdateSettings( bool bGet )
	{
		CopyVar( SourceControlOn,gSettings.ssafeParams.SourceControlOn,bGet );
		CopyVar( SourceControlPluginName,gSettings.ssafeParams.SourceControlPluginName,bGet );
		...
		if (SourceControlPluginName=="")
		{
			tableSSafe.SetName("Source Control Settings");
		  SourceControlOn.SetFlags(IVariable::UI_DISABLED);
		}
		else
			tableSSafe.SetName(SourceControlPluginName+" Settings" );
	}
	//////////////////////////////////////////////////////////////////////////
};
...
public:
	...
	CVariable<bool> alternativeCameraControls;
...
public:
	...
	CPreferencesPage_ViewportMovement()
	{
		...
		AddVariable( tableCamera,alternativeCameraControls,"Alternative Camera Controls" );
	...
	void UpdateSettings( bool bGet )
	{
		...
		CopyVar( alternativeCameraControls,gSettings.bAlternativeCameraControls,bGet );
	}
	//////////////////////////////////////////////////////////////////////////
};
...
IPreferencesPage* CStdPreferencesClassDesc::CreatePage( int index,const CRect &rc,CWnd *pParentWnd )
{
	...
	//////////////////////////////////////////////////////////////////////////
	case 7:	pPage = new CPreferencesPage_FlowGraphGeneral();	break;
	//////////////////////////////////////////////////////////////////////////
	case 8:	pPage = new CPreferencesPage_FlowGraphColors();	break;
	}
	if (pPage)
	{

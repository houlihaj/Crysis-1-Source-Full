...
// -------------------------------------------------------------------------
//  File name:   FacialEditorDialogC3DSolver.cpp
//  Version:     v1.00
//  Created:     19/08/2008 by Marco C.
//  Description: 
// -------------------------------------------------------------------------
//  History:
//
...
struct tMarker 
{
	...
	{
		strcpy_s(sMarker,szMarker);
		strcpy_s(sJoystick,szJoystick);
		if (szJoystick3D)
		{
			strcpy_s(sJoystick3D,szJoystick3D);
			b3D=true;
		}
		else
		{
...
void CFacialEditorDialog::LoadC3DFile(const char* filename)
{
	...
	//////////////////////////////////////////////////////////////////////////
	// general joystick scaling generated from a few ROMs, modified
	// manually to match simmetries
	m_lstMarkers[FA_LT_EYEBROW_LT].fScaleX=142.542282f;
	m_lstMarkers[FA_LT_EYEBROW_LT].fScaleY=54.840557f;
	m_lstMarkers[FA_LT_EYEBROW_RT].fScaleX=481.471466f;
	m_lstMarkers[FA_LT_EYEBROW_RT].fScaleY=49.852386f;

	m_lstMarkers[FA_RT_EYEBROW_LT].fScaleX=481.471466f;
	m_lstMarkers[FA_RT_EYEBROW_LT].fScaleY=49.852386f;
	m_lstMarkers[FA_RT_EYEBROW_RT].fScaleX=142.542282f;
	m_lstMarkers[FA_RT_EYEBROW_RT].fScaleY=54.840557f;

	m_lstMarkers[FA_LT_CHEEK].fScaleX=134.959427f;
	m_lstMarkers[FA_LT_CHEEK].fScaleY=70.277756f;
	m_lstMarkers[FA_RT_CHEEK].fScaleX=134.959427f;
	m_lstMarkers[FA_RT_CHEEK].fScaleY=70.277756f;

	m_lstMarkers[FA_MOUTH_LT].fScaleX=42.826359f;
	m_lstMarkers[FA_MOUTH_LT].fScaleY=37.000694f;
	m_lstMarkers[FA_MOUTH_RT].fScaleX=42.826359f;
	m_lstMarkers[FA_MOUTH_RT].fScaleY=37.000694f;

	m_lstMarkers[FA_LT_LIP_TOP].fScaleX=63.166412f;
	m_lstMarkers[FA_LT_LIP_TOP].fScaleY=48.105827f;
	m_lstMarkers[FA_RT_LIP_TOP].fScaleX=63.166412f;
	m_lstMarkers[FA_RT_LIP_TOP].fScaleY=48.105827f;

	m_lstMarkers[FA_LT_LIP_BOTTOM].fScaleX=28.449141f;
	m_lstMarkers[FA_LT_LIP_BOTTOM].fScaleY=18.451853f;
	m_lstMarkers[FA_RT_LIP_BOTTOM].fScaleX=28.449141f;
	m_lstMarkers[FA_RT_LIP_BOTTOM].fScaleY=18.451853f;

	m_lstMarkers[FA_LT_NOSE].fScaleX=228.665939f;
	m_lstMarkers[FA_LT_NOSE].fScaleY=103.134438f;
	m_lstMarkers[FA_RT_NOSE].fScaleX=228.665939f;
	m_lstMarkers[FA_RT_NOSE].fScaleY=103.134438f;
	m_lstMarkers[FA_CT_NOSTIP].fScaleX=228.665939f;
	m_lstMarkers[FA_CT_NOSTIP].fScaleY=103.134438f;

	m_lstMarkers[FA_LT_EYELID_TOP].fScaleX=225.255173f;
	m_lstMarkers[FA_LT_EYELID_TOP].fScaleY=85.320061f;
	m_lstMarkers[FA_LT_EYELID_LOW].fScaleX=209.848404f;
	m_lstMarkers[FA_LT_EYELID_LOW].fScaleY=179.385498f;

	m_lstMarkers[FA_RT_EYELID_TOP].fScaleX=225.255173f;
	m_lstMarkers[FA_RT_EYELID_TOP].fScaleY=85.320061f;
	m_lstMarkers[FA_RT_EYELID_LOW].fScaleX=209.848404f;
	m_lstMarkers[FA_RT_EYELID_LOW].fScaleY=179.385498f;

	m_lstMarkers[FA_CT_LIP_TOP].fScaleX=63.166412f;
	m_lstMarkers[FA_CT_LIP_TOP].fScaleY=48.105827f;
	m_lstMarkers[FA_CT_LIP_BOTTOM].fScaleX=28.449141f;
	m_lstMarkers[FA_CT_LIP_BOTTOM].fScaleY=18.451853f;

	m_lstMarkers[FA_CHIN].fScaleX=29.545271f;
	m_lstMarkers[FA_CHIN].fScaleY=18.549459f;
	m_lstMarkers[FA_CHIN_LT].fScaleX=29.545271f;
	m_lstMarkers[FA_CHIN_LT].fScaleY=18.549459f;
	m_lstMarkers[FA_CHIN_RT].fScaleX=29.545271f;
	m_lstMarkers[FA_CHIN_RT].fScaleY=18.549459f;	

	for (int k=FA_LT_JAWMID;k<=FA_RT_JAWOUT;k++)
	{
		m_lstMarkers[k].fScaleX=m_lstMarkers[FA_CHIN].fScaleX;
		m_lstMarkers[k].fScaleY=m_lstMarkers[FA_CHIN].fScaleY;
	}

	m_lstMarkers[FA_LT_CHEBCK].fScaleX=134.959427f;
	m_lstMarkers[FA_LT_CHEBCK].fScaleY=70.277756f;
	m_lstMarkers[FA_RT_CHEBCK].fScaleX=134.959427f;
	m_lstMarkers[FA_RT_CHEBCK].fScaleY=70.277756f;

	m_lstMarkers[FA_LT_CREASE].fScaleX=228.665939f;
	m_lstMarkers[FA_LT_CREASE].fScaleY=103.134438f;
	m_lstMarkers[FA_RT_CREASE].fScaleX=228.665939f;
	m_lstMarkers[FA_RT_CREASE].fScaleY=103.134438f;	

	m_lstMarkers[FA_LT_SNER].fScaleX=228.665939f;
	m_lstMarkers[FA_LT_SNER].fScaleY=103.134438f;
	m_lstMarkers[FA_RT_SNER].fScaleX=228.665939f;
	m_lstMarkers[FA_RT_SNER].fScaleY=103.134438f;

	m_lstMarkers[FA_LT_PUF].fScaleX=63.166412f;
	m_lstMarkers[FA_LT_PUF].fScaleY=48.105827f;
	m_lstMarkers[FA_RT_PUF].fScaleX=63.166412f;
	m_lstMarkers[FA_RT_PUF].fScaleY=48.105827f;


	m_lstMarkers[FA_RT_EAR].fScaleX=134.959427f;
	m_lstMarkers[FA_RT_EAR].fScaleY=70.277756f;
	m_lstMarkers[FA_LT_EAR].fScaleX=134.959427f;
	m_lstMarkers[FA_LT_EAR].fScaleY=70.277756f;

	for (int k=FA_RT_BROUT;k<=FA_RT_FHDUP;k++)
	{
		m_lstMarkers[k].fScaleX=m_lstMarkers[FA_LT_EYEBROW_LT].fScaleX;
		m_lstMarkers[k].fScaleY=m_lstMarkers[FA_LT_EYEBROW_LT].fScaleY;
	} //k

	for (int k=FA_LT_TEND;k<=FA_RT_TEND;k++)
	{
		m_lstMarkers[k].fScaleX=m_lstMarkers[FA_CHIN].fScaleX/4.0f;
		m_lstMarkers[k].fScaleY=m_lstMarkers[FA_CHIN].fScaleY/4.0f;
	}

	m_lstMarkers[FA_LT_LIDLOIN].fScaleX=209.848404f;
	m_lstMarkers[FA_LT_LIDLOIN].fScaleY=179.385498f;
	m_lstMarkers[FA_RT_LIDLOIN].fScaleX=209.848404f;
	m_lstMarkers[FA_RT_LIDLOIN].fScaleY=179.385498f;

	m_lstMarkers[FA_LT_TMP].fScaleX=134.959427f;
	m_lstMarkers[FA_LT_TMP].fScaleY=70.277756f;
	m_lstMarkers[FA_RT_TMP].fScaleX=134.959427f;
	m_lstMarkers[FA_RT_TMP].fScaleY=70.277756f;

	m_lstMarkers[FA_LT_NOSTRIL].fScaleX=228.665939f;
	m_lstMarkers[FA_LT_NOSTRIL].fScaleY=103.134438f;
	m_lstMarkers[FA_RT_NOSTRIL].fScaleX=228.665939f;
	m_lstMarkers[FA_RT_NOSTRIL].fScaleY=103.134438f;

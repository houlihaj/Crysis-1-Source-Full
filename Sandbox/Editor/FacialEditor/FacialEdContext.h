...
public:
	...
	void HandleExpressionNameDropToLibrary(IFacialEffector* pParentExpression, COleDataObject* pDataObject);
	...
	//const uchar	*GetVideoFrame(int nFrame);

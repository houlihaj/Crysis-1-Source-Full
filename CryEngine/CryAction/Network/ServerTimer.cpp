...
CTimeValue CServerTimer::GetFrameStartTime(ETimer /* which */) const
{
...
float CServerTimer::GetRealFrameTime(const bool ignoreGamePause) const
{
...
void CServerTimer::SetTimeScale(float scale)
{
}

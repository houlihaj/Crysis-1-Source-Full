...
struct IVehicleSeat 
{
  ...
  virtual void ForceFinishExiting() = 0;
	virtual void SetSteeringActionY(float value) = 0;
	virtual Matrix34 GetExitTM(IActor* pActor, bool opposite = false) = 0;
	virtual bool TestExitPosition(IActor* pActor, Vec3& testPos, EntityId* pBlockingEntity) = 0;
};

...
struct IFireMode
{
	...
	virtual void EnterModify() = 0;
	virtual void ExitModify() = 0;
	...
	virtual bool	HasReloadFeedback() const = 0;
...
struct IWeapon
{
  ...
  virtual void SetDestinationEntity(EntityId targetId) = 0;
	...
	virtual bool		IsTrainMounted() = 0;
	virtual Vec3		GetTrainMountedDir() = 0;

	virtual void		SetAutoPicked(bool set) = 0;
};

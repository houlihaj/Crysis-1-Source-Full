...
template<int n> struct SConvertToBinary;
template<> struct SConvertToBinary<1> { typedef uint8 binary_type; };
template<> struct SConvertToBinary<2> { typedef uint16 binary_type; };
template<> struct SConvertToBinary<4> { typedef uint32 binary_type; };
template<> struct SConvertToBinary<8> { typedef uint64 binary_type; };
#define BINARY(variable) ((SConvertToBinary<sizeof(variable)>::binary_type&)variable)

template<int n> struct SConvertToFloating;
template<> struct SConvertToFloating<4> { typedef float floating_type; };
template<> struct SConvertToFloating<8> { typedef double floating_type; };
#define FLOATING(variable) ((SConvertToFloating<sizeof(variable)>::floating_type&)variable)

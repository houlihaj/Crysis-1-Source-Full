...
struct ICharacterInstance : ISkinnable
{
	...
	virtual void SetAlternativeTargetForGetRandomPos(ICharacterInstance *target)=0;
	...
	//big hack for the expansion pack: characters on the moving train should use eMCM_Entity method
	virtual void SetForceInPlaceAnimsOnMovingTrain() = 0;
	virtual bool GetForceInPlaceAnimsOnMovingTrain() = 0;
};

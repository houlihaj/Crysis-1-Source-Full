...
public:
	CBreakableGrid2d() { m_pt=0; m_pTris=0; m_pCellDiv=0; m_nTris=0; }
	~CBreakableGrid2d() { 
		if (m_pt) delete[] m_pt; 
	...
	enum tritypes { TRI_AVAILABLE=1<<31, TRI_FIXED=1<<29, TRI_EMPTY=1<<28, TRI_STABLE=1<<27, TRI_PROCESSED=1<<26 };

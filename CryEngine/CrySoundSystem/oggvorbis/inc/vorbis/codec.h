...
/* vorbis_dsp_state buffers the current vorbis audio
   analysis/synthesis state.  The DSP state beogg_int32_ts to a specific
   logical bitstream ****************************************************/
...
the analysis/synthesis stream; it beogg_int32_ts to a specific logical
bitstream, but is independant from other vorbis_blocks beogg_int32_ting to
...
extern float    vorbis_granule_time(vorbis_dsp_state *v,
				    ogg_int64_t granulepos);

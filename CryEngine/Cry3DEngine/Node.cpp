...
////////////////////////////////////////////////////////////////////////
//
//COldNodeCGF::COldNodeCGF() : CBaseObj()
//{
//	m_pObj			= NULL;
////	m_sPropStr		= NULL;
////	m_ppChildren	= NULL;
...
//}
//
//bool COldNodeCGF::Load(CXFile *f, int pos)
//{
...
//		
//    m_ppChildren = (COldNodeCGF **) malloc(m_Chunk.nChildren*sizeof(COldNodeCGF*));
//		assert(m_pnChildrenIds);
//    memset(m_ppChildren,0,m_Chunk.nChildren*sizeof(COldNodeCGF*));
//		
...
//}
//
//void COldNodeCGF::Bind(CBaseObj ** all_objects, int n_obj)
//{
//  if(m_bBinded) 
//    return;
//

...
: m_renderer( &renderer )
{
	...
	gEnv->pConsole->AddCommand("r_debug_renderer_show_window", DebugRendererShowWindow, 0);
	gEnv->pConsole->AddCommand("r_debug_renderer_set_eye_pos", DebugRendererSetEyePos , 0);
#endif
}
